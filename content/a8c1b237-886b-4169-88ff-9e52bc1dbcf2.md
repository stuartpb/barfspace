...
This is kind of related to the BISNES/BIGDOG stuff, as well as the Federated World stuff

- [ ] Build a quest based on [the old notes on collaboration][collaboration.md].
  - [ ] Link that page into a few other bagtent-adjacent musings or whatever.
...
Apparently this was the origin of the thought process that led into [Project Akira][]?
...
editor's note for the future: this whole next chunk can pretty much just be dropped and live in the Git history. the relevant stuff to remember is that there should be a guideline on how non-checkbox entries in Quests lists should be considered, and that "here are links I'm saving for posterity in this pursuit" should be a distinct "thing" that I do as much as Quests
